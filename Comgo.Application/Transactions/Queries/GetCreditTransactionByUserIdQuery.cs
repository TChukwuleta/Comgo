...
{
    public class GetCreditTransactionByUserIdQuery : IRequest<Result>, IBaseValidator
    {
    ...
    public class GetCreditTransactionByUserIdQueryHandler : IRequestHandler<GetCreditTransactionByUserIdQuery, Result>
    {
        private readonly IAppDbContext _context;
        private readonly IAuthService _authService;
        public GetCreditTransactionByUserIdQueryHandler(IAppDbContext context, IAuthService authService)
        {
            _context = context;
            _authService = authService;
        }

        public async Task<Result> Handle(GetCreditTransactionByUserIdQuery request, CancellationToken cancellationToken)
        {
